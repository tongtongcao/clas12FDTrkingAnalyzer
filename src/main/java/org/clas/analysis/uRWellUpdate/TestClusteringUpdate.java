 ...
 * @author Tongtong Cao
 */
public class TestClusteringUpdate extends BaseAnalysis {     
    private final double uRWellResidualCut = 0.11;
...
*/        
        ...
        for(Cluster cls1 : map_cls1_cls2_matched.keySet()){
            ...
            if(ratioMatchedHits1 == 1 && ratioMatchedHits2 == 1){
                ...
                if(ratioMatchedHits1 == 1) {
                    //addDemoGroupLoopClusters(localEvent1, localEvent2, cls1.sector(), "matched1R1.0");
                }
                
                if(ratioMatchedHits2 == 1) {
                    //addDemoGroupLoopClusters(localEvent1, localEvent2, cls1.sector(), "matched2R1.0");
                }
            }
        ...
        // Matched clusters in SL1
        Map<Cluster, Cluster> map_cls1_cls2_matched_SL1 = new HashMap();
        for(Cluster cls : map_cls1_cls2_matched_added.keySet()){
            map_cls1_cls2_matched.remove(cls);
        }
        for(Cluster cls1 : map_cls1_cls2_matched.keySet()){
        ...
        for(Cluster cls1 : clsListExtraSample1){
            ...
            //addDemoGroupLoopClusters(localEvent1, localEvent2, cls1.sector(), "lost"); 
        }
        for(Cluster cls2 : clsListExtraSample2){
    ...
    public static void main(String[] args) {
        ...
        if (inputList.isEmpty() == true) {
            parser.printUsage();
            inputList.add("/Users/caot/research/clas12/data/mc/uRWELL/upgradeTrackingWithuRWELL/rga-sidis-uRWell-2R_denoise/100/reconBg_DConly/recon_iss471.hipo");
            inputList.add("/Users/caot/research/clas12/data/mc/uRWELL/upgradeTrackingWithuRWELL/rga-sidis-uRWell-2R_denoise/100nA/updateClusteringWithURWell/dcURWellClustering_100nA.hipo");
            maxEvents = 1000;
        ...
        TestClusteringUpdate analysis = new TestClusteringUpdate();
