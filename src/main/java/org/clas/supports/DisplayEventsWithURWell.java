...
import org.clas.demo.DemoEventWithURWell;
...
public class DisplayEventsWithURWell{                  
    public static void main(String[] args) {
        ...
        while(reader.hasNext()){
            ...
            LocalEvent localEvent = new LocalEvent(localReader, event, Constants.AITB, true);
            int eventNum = localEvent.getRunConfig().event();
            if(eventList.contains(eventNum)){
                if(sector == -1){
                    DemoEventWithURWell demo = new DemoEventWithURWell("E" + eventNum, localEvent);
                    ...
                    DemoSectorWithURWell demo = new DemoSectorWithURWell(str, localEvent, sector);
